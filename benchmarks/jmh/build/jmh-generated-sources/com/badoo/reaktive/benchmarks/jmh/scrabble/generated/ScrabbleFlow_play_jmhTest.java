...
import com.badoo.reaktive.benchmarks.jmh.scrabble.generated.ScrabbleFlow_jmhType;
public final class ScrabbleFlow_play_jmhTest {
    ...
    public BenchmarkTaskResult play_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            ScrabbleFlow_jmhType l_scrabbleflow0_G = _jmh_tryInit_f_scrabbleflow0_G(control);
            ...
            while (control.warmupShouldWait) {
                blackhole.consume(l_scrabbleflow0_G.play());
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            play_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_scrabbleflow0_G);
    ...
    public static void play_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, ScrabbleFlow_jmhType l_scrabbleflow0_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult play_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            play_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_scrabbleflow0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void play_avgt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, ScrabbleFlow_jmhType l_scrabbleflow0_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult play_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            play_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_scrabbleflow0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void play_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, ScrabbleFlow_jmhType l_scrabbleflow0_G) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult play_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            play_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_scrabbleflow0_G);
            control.preTearDown();
    ...
    public static void play_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, ScrabbleFlow_jmhType l_scrabbleflow0_G) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile ScrabbleFlow_jmhType f_scrabbleflow0_G;
    
    ScrabbleFlow_jmhType _jmh_tryInit_f_scrabbleflow0_G(InfraControl control) throws Throwable {
        ScrabbleFlow_jmhType val = f_scrabbleflow0_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            ...
            val = f_scrabbleflow0_G;
            if (val != null) {
                return val;
            }
            val = new ScrabbleFlow_jmhType();
            val.readyTrial = true;
            f_scrabbleflow0_G = val;
            } catch (Throwable t) {
