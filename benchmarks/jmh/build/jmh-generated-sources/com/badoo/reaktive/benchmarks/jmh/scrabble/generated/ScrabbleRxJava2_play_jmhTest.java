...
import com.badoo.reaktive.benchmarks.jmh.scrabble.generated.ScrabbleRxJava2_jmhType;
public final class ScrabbleRxJava2_play_jmhTest {
    ...
    public BenchmarkTaskResult play_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            ScrabbleRxJava2_jmhType l_scrabblerxjava20_G = _jmh_tryInit_f_scrabblerxjava20_G(control);
            ...
            while (control.warmupShouldWait) {
                blackhole.consume(l_scrabblerxjava20_G.play());
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            play_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_scrabblerxjava20_G);
    ...
    public static void play_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, ScrabbleRxJava2_jmhType l_scrabblerxjava20_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult play_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            play_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_scrabblerxjava20_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void play_avgt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, ScrabbleRxJava2_jmhType l_scrabblerxjava20_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult play_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            play_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_scrabblerxjava20_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void play_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, ScrabbleRxJava2_jmhType l_scrabblerxjava20_G) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult play_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            play_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_scrabblerxjava20_G);
            control.preTearDown();
    ...
    public static void play_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, ScrabbleRxJava2_jmhType l_scrabblerxjava20_G) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile ScrabbleRxJava2_jmhType f_scrabblerxjava20_G;
    
    ScrabbleRxJava2_jmhType _jmh_tryInit_f_scrabblerxjava20_G(InfraControl control) throws Throwable {
        ScrabbleRxJava2_jmhType val = f_scrabblerxjava20_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            ...
            val = f_scrabblerxjava20_G;
            if (val != null) {
                return val;
            }
            val = new ScrabbleRxJava2_jmhType();
            val.readyTrial = true;
            f_scrabblerxjava20_G = val;
            } catch (Throwable t) {
